...
<?php h(4); ?> 
		<!-- START HOME -->
		<section data-stellar-background-ratio="0.3" id="home" class="home_parallax ripple" style="background-image: url(assets/img/bg/restaurant-bg.jpg);  background-size:cover; background-position: center center;">			
			<div class="container">
				<div class="row">
				  <div class="col-lg-12 text-center">
					<div class="hero-text">
						<h1>Don't eat less, just eat real</h1>
				...
				<div class="row">					
					<div class="col-lg-3 col-sm-6 col-xs-12">
						<div class="single-team">
							<div class="img"><img src="assets/img/team/person1.png" class="img-fluid" alt=""></div>
					...
					<div class="col-lg-3 col-sm-6 col-xs-12">
						<div class="single-team">
							<div class="img"><img src="assets/img/team/person2.png" class="img-fluid" alt=""></div>
							<div class="team-content">
					...
					<div class="col-lg-3 col-sm-6 col-xs-12">
						<div class="single-team">
							<div class="img"><img src="assets/img/team/person3.png" class="img-fluid" alt=""></div>
							<div class="team-content">
								<h3>Mark Linomi</h3>
								<p>Marketer</p>
								<ul class="social">
					...
					<div class="col-lg-3 col-sm-6 col-xs-12">
						<div class="single-team">
							<div class="img"><img src="assets/img/team/person4.png" class="img-fluid" alt=""></div>
							<div class="team-content">
								<h3>Amira Yerden</h3>
								<p>UI/UX Designer</p>
								<ul class="social">
		...
		<!-- START PRICING  -->
		<section id="hour" class="our_pricing section-padding">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="section-title text-center">
					...
					<div class="col-xs-12 col-sm-4 col-lg-4">
						<div class="pricingTable pricingTable-2">
							...
							<ul class="pricing-content">
								<li>Mon - Thu: 7am - 11am </li>
								<li>Fri: 7am - 12pm </li>
								<li>15 Domains</li>
								<li>Sat: 7am - 3pm </li>
							</ul>
							<a href="#" class="btn btn-lg btn-price-bg">Book Now</a>
						</div>
					</div><!-- END COL  -->
					<div class="col-xs-12 col-sm-4 col-lg-4">
						<div class="pricingTable pricingTable-2">
		...
		<!-- START MENU -->
		<section id="menu" class="menu-area section-padding">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="section-title text-center">
				...
				<div class="col-lg-12 text-center">
					<ul class="portfolio-filters text-center">
						...
						<li class="filter" data-filter="launch">Launch</li>
				...
				<div class="row grid">
						<div class="col-lg-6 col-xs-12 col-sm-12 no-padding mix launch coffee">						
							<div class="menu-item"> <img src="assets/img/menu/dish-1.png" alt="" class="img-fluid">
								<div class="menu-inner">
									<h4>Chicken Fried Salad</h4> 
									<span>20$</span>
								</div>
								<p> Aperiam tempore sit,perferendis numquam repudiandae porro voluptate dicta saepe facilis.</p>
							</div>
						</div><!--- END COL -->
						<div class="col-lg-6 col-xs-12 col-sm-12 no-padding mix breakfast dinner">						
							<div class="menu-item"> <img src="assets/img/menu/dish-2.png" alt="" class="img-fluid">
								<div class="menu-inner">
									<h4>Chicken Fried Salad</h4> 
									<span>20$</span>
								</div>
						...
						<div class="col-lg-6 col-xs-12 col-sm-12 no-padding mix launch coffee">						
							<div class="menu-item"> <img src="assets/img/menu/dish-3.png" alt="" class="img-fluid">
								<div class="menu-inner">
									<h4>Chicken Fried Salad</h4> 
									<span>20$</span>
								</div>
						...
						<div class="col-lg-6 col-xs-12 col-sm-12 no-padding mix breakfast snacks">						
							<div class="menu-item"> <img src="assets/img/menu/dish-4.png" alt="" class="img-fluid">
								<div class="menu-inner">
									<h4>Chicken Fried Salad</h4> 
									<span>20$</span>
								</div>
						...
						<div class="col-lg-6 col-xs-12 col-sm-12 no-padding mix launch dinner">						
							<div class="menu-item"> <img src="assets/img/menu/dish-5.png" alt="" class="img-fluid">
								<div class="menu-inner">
									<h4>Chicken Fried Salad</h4> 
									<span>20$</span>
								</div>
						...
						<div class="col-lg-6 col-xs-12 col-sm-12 no-padding mix breakfast dinner snacks">						
							<div class="menu-item"> <img src="assets/img/menu/dish-6.png" alt="" class="img-fluid">
								<div class="menu-inner">
									<h4>Chicken Fried Salad</h4> 
									<span>20$</span>
								</div>
