...
$sql="select * from inf_client where clientId in ('1944','1969','1490','1495','2044','2043','2064','2063','1657','0759','1935','2038','1988','1971','1908','1993','2080','2046','1936','2051','30142','2074')";
$list=$X->sql($sql);
foreach ($list as $c) {
        print_r($c);
	$clientId=$c['clientId'];
...
$sql="select clientId, employeeId, id from inf_client_employee where dependentId = '' ";
$sql.=" and clientId in ('1944','1969','1490','1495','2044','2043','2064','2063','1657','0759','1935','2038','1988','1971','1908','1993','2080','2046','1936','2051','30142','2074') order by id";
$list=$X->sql($sql);
$count=sizeof($list);
$i=0;
foreach ($list as $c) {
...
$sql.=" and clientId in ('1944','1969','1490','1495','2044','2043','2064','2063','1657',";
$sql.=" '0759','1935','2038','1988','1971','1908','1993','2080','2046','1936','2051','30142','2074')";
$list=$X->sql($sql);
...
//
$sql="select * from inf_client_employee where dependentId = '' and clientId in ";
$sql.="('1944','1969','1490','1495','2044','2043','2064','2063','1657','0759','1935', ";
$sql.="'2038','1988','1971','1908','1993','2080','2046','1936','2051','30142','2074')";
$sql.=" order by clientId, employeeId";
$employees=$X->sql($sql);
...
$sql="select clientId from inf_client ";
$sql.=" where clientId in ('1944','1969','1490','1495','2044','2043','2064','2063','1657','0759','1935','2038','1988','1971','1908','1993','2080','2046','1936','2051','30142','2074') order by clientId";
$clients=$X->sql($sql);
...
$sql="select * from nua_company where infinity_id in ";
$sql.=" ('1944','1969','1490','1495','2044','2043','2064','2063','1657','0759','1935','2038','1988','1971','1908','1993','2080','2046','1936','2051','30142','2074') order by id";
$clients=$X->sql($sql);
foreach($clients as $client) {
