...
$B=new BSCScan();
$l=$B->getGeckoDerivativeExchanges();
$dateTime = time();
$list=json_decode($l,true);
$counter=0;
$table_name="GOATX_RESEARCH_DERIVATIVE_EXCHANGES";
...
$sql0="UPDATE " . $table_name . " SET ";
             ...
             $sql0 .= do_one("open_interest_btc",$n,$x[0]);
             $sql0 .= do_one("trade_volume_24h_btc",$n,$x[0]);
             $sql0 .= do_one("number_of_perpetual_pairs",$n,$x[0]);
             $sql0 .= do_one("number_of_futures_pairs",$n,$x[0]);		
