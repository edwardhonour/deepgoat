...
echo $record_count;
        ...
        if ($data[7]=='APA') {
             ...
             if ($data[1]!="Type"&&$data[1]!="ID") {
                     ...
                     //-- INSERT INTO CENSUS
                     //--
					$sql="select * from nua_monthly_member_census where month_id = '2022-02' and employee_code = 'n" . $current_employee_id . "' and dependent_code = ''"; 
					$t=$X->sql($sql);
					if (sizeof($t)==0) {
					$po=array();
...
if ($current_org!=17) {
				...
				$dcount++;
					...
					$sql="select * from nua_monthly_member_census where month_id = '2022-02' and employee_code = 'n" . $current_employee_id . "' and dependent_code = 'n" . $current_employee_id . "." . $dcount . "'"; 
					$t=$X->sql($sql);
					if (sizeof($t)==0) {				
				$po=array();
				$po['table_name']="nua_monthly_member_census";
