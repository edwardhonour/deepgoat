...
$sql="select clientId from inf_client where clientId in (select infinity_id from nua_company where org_id = 17 and ";
$sql.=" id in (select distinct company_id from nua_company_invoice)) order by 1";
$clients=$X->sql($sql);
