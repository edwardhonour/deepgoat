...
//-- Part 1: Check for new Wallets that are connected to active users.

$sql="SELECT ID, wallet_address from GOATX_WALLET WHERE exclude = 'N' and wallet_address in (select WALLET_ADDRESS FROM GOATX_USER_WALLET)";
$list=$X->sql($sql);
$i=0;
